...
public class StudentLevelTest {
    ...
    @Test
    public void whenOneStudent() {
        List<Student> input = new ArrayList<>();
        input.add(new Student(30, "Misha"));
        input.add(new Student(100, "Slava"));
        List<Student> expected = List.of(new Student(100, "Slava"));
        assertThat(StudentLevel.levelOf(input, 50)).containsAll(expected);
    }
}